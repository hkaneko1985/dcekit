...
# Hyperparameters are optimized with cross-validation (CV) and Bayesian optimization (BO)
...
model.cv_bo(autoscaled_variables_train, numbers_of_x, numbers_of_y, candidates_of_shape_of_map,
             candidates_of_shape_of_rbf_centers, candidates_of_variance_of_rbfs,
             candidates_of_lambda_in_em_algorithm, fold_number, number_of_iterations, bo_iteration_number)
