...
import numpy as np
from dcekit.optimization import fast_opt_svr_hyperparams_cv
# import pandas as pd
...
optimal_c, optimal_epsilon, optimal_gamma = fast_opt_svr_hyperparams_cv(autoscaled_x_train, autoscaled_y_train, cs,
                                                                        epsilons,
                                                                        gammas, fold_number)
