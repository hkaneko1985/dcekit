...
import numpy as np
from dcekit.validation import y_randomization
...
# settings
regression_method = 'ols'  # 'ols' or 'gpr'
...
# y-randomization
y_train_rand, estimated_y_train_rand = y_randomization(model, x_train, y_train)
