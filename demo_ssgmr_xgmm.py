...
from dcekit.generative_model import SSGMRXGMM
...
print('Results of forward analysis with ssGMR-xGMM')
...
print('---------------------------')
print('Results of direct inverse analysis with ssGMR-xGMM')
estimated_x_test = (
