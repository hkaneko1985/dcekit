...
k_in_knnpc_for_class1 = 5
k_in_knnpc_for_class0 = 5
k_in_knnpc_per_class = {1 : k_in_knnpc_for_class1, 0 : k_in_knnpc_for_class0}
#k_in_knnpc_per_class = 5
...
# kNNPC model
model = KNeighborsPerClassClassifier(n_neighbors=k_in_knnpc_per_class, metric='euclidean')
